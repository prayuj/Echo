...
(function init(moduleNames, moduleSources, evaluate, globalObject) {
    ...
    moduleNames.forEach(function(name, i) {
        const exec = evaluate.call(globalObject,
                                 "(function(require, exports) { " + moduleSources[i] + "\n})",
                                 name + ".js",
                                 1);
        const exported = {};
        exec.call(exported, requireFile, exported);
        Narcissus[name] = exported;
    });
