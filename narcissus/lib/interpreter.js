...
var globalBase = {
    ...
    Array: function (dummy) {
        ...
        // return;
        return hostGlobalArray.apply(this, arguments);
    },
        ...
        while (!n.condition || getValue(execute(n.condition, x))) {
            try {
                ...
                if (e === BREAK_SIGNAL && x.target === n) {
                    ...
                    throw e; // Re-throw the exception if it doesn't match BREAK_SIGNAL or CONTINUE_SIGNAL
                }
            }
...
function newFunction(n, x) {
    ...
    var handler = {
        ...definitions.makePassthruHandler(props),
        apply(target, thisArg, argumentsList) {
            return fint.call(target, thisArg, argumentsList, x);
        },
        construct(target, argumentsList, newTarget) {
