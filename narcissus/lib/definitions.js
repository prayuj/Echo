...
function mixinHandler(redirect, catchall) {
    ...
    function hasMux(target, name) {
        return name in targetFor(name);
    }

    return {
        getOwnPropertyDescriptor: getMuxPropertyDescriptor,
        // getPropertyDescriptor: getMuxPropertyDescriptor, deprecated
        // getOwnPropertyNames: getMuxPropertyNames, deprecated
        ...
        // FIXME: ha ha ha
        // fix: function() { return 'empty' }, deprecated
        has: hasMux,
        ...
        // enumerate: enumerateMux, deprecated, use ownKeys
        // keys: enumerateMux deprecated
    };
}
